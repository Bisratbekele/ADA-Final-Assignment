...
# 7. Create exclusion datasets step-by-step
...
```
# 8. Figure 1: Participant Selection Flowchart
```{r}
...
# 9. Test linearity assumption for continuous predictors
...
# 10. Univariate logistic regression: Vitamin D and Depression
...
**Interpretation:** Those with insufficient vitamin D have 46% higher odds of depression (OR = 1.46, 95% CI: 1.18–1.80, p < 0.001).

**Interpretation:** Those with deficient vitamin D have about 81% higher odds of depression (OR = 1.81, 95% CI: 1.44–2.27, p < 0.001).



# 11. Multivariate logistic regression: Adjusted model
...
# 13. Influential observations using Cook's Distance
...
# 15. Table 1: Baseline Characteristics
```{r}
# Variable labels
